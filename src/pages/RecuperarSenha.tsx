            ...
            <>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3.5 rounded-full border border-muted bg-background text-foreground font-semibold text-sm flex items-center justify-center gap-3 hover:bg-muted/50 transition-colors"
                >
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-full border border-muted bg-background text-foreground font-semibold text-sm flex items-center justify-center gap-3 hover:bg-muted/50 transition-colors"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C4.24 16.7 4.89 10.33 9 10.18c1.17.05 1.99.68 2.69.72.97-.2 1.9-.75 2.93-.68 1.24.1 2.17.58 2.78 1.47-2.56 1.53-1.95 4.89.58 5.82-.49 1.3-.87 2.57-1.93 3.77zM12.03 10.13c-.13-2.07 1.55-3.84 3.47-3.97.26 2.27-2.07 3.97-3.47 3.97z"/></svg>
                  Entrar com Apple
                </button>
              </div>
