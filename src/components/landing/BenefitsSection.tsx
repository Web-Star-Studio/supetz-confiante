    ...
    <section id="beneficios-rapidos" className="relative overflow-hidden bg-supetz-bg-alt py-20 md:py-24">
      ...
      <div className="mx-auto max-w-6xl px-6">
        <motion.div
          ...
          className="supet-soft-panel bg-supetz-text text-white relative overflow-hidden p-8 md:p-12"
        >
          <img
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-[1.2fr_1fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-relaxed text-white/80 md:text-base font-medium">
            ...
            {/* Inner box - reset this back to white for high contrast readibility of the benefits */}
            <div className="rounded-3xl border border-supetz-orange/20 bg-white p-6 md:p-7 shadow-lg">
