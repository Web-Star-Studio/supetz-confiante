...
export default function BenefitsSection() {
  return (
    <section id="beneficios-rapidos" className="relative overflow-hidden bg-white py-24 md:py-32">
      <div className="pointer-events-none absolute -top-20 left-0 h-96 w-96 rounded-full bg-supet-orange/5 blur-[100px]" />
      <div className="pointer-events-none absolute bottom-0 right-0 h-96 w-96 rounded-full bg-supet-orange/5 blur-[100px]" />
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center lg:gap-20">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md mx-auto lg:mx-0 overflow-hidden rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.12)] border border-supet-text/5"
          >
            <img
          ...
          >
            <h2 className="text-3xl font-extrabold leading-tight text-supet-text md:text-4xl lg:text-5xl text-balance">
              Seu pet livre de coceiras, feridas e queda de pelos em poucas semanas
            </h2>
            <p className="mt-6 text-base leading-relaxed text-supet-text/70 md:text-lg font-medium text-balance">
            ...
            <div className="mt-10">
              <h3 className="text-xs font-extrabold uppercase tracking-[0.15em] text-supet-orange">Benefícios rápidos</h3>
              <motion.ul
              ...
              >
                {quickBenefits.map((benefit) => (
                  <motion.li key={benefit} variants={benefitItemVariants} className="flex items-start gap-3.5">
                    <div className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-supet-orange/15 text-supet-orange">
                      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="3">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <span className="text-sm font-bold text-supet-text md:text-base leading-tight">
                      {benefit}
                    </span>
                  </motion.li>
                ))}
