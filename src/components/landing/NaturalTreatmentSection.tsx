...
export default function NaturalTreatmentSection() {
  ...
  return (
    <section ref={sectionRef} id="tratamento-natural" className="relative overflow-hidden bg-supetz-bg py-20 md:py-24">
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="relative mt-12 hidden h-[640px] lg:block">
          ...
          <motion.div
            ...
            className="pointer-events-none absolute left-1/2 top-1/2 h-[432px] w-[432px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-supetz-orange/12 shadow-[0_0_0_1px_rgba(255,145,77,0.05),0_0_42px_rgba(255,145,77,0.14)]"
          />
